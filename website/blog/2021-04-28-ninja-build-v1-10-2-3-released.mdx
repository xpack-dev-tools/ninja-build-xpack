...
seo_title: Version 1.10.2-3 released
description: Version 1.10.2-3 is a maintenance release of xPack Ninja Build.
keywords:
  - xpack
  - ninja-build
  - release
...
- [[#1](https://github.com/xpack-dev-tools/ninja-build-xpack/issues/1)]: on Windows, starting npm/xpm applications via the `.cmd` forwarders
