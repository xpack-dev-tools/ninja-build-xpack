...
seo_title: Version 1.10.2-2 released
...
- [[#1](https://github.com/xpack-dev-tools/ninja-build-xpack/issues/1)]: as discoverd after starting to use meson, starting applications on
