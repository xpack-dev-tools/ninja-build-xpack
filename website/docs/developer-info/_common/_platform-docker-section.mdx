...
xpm run docker-prepare --config ${ props.platform } -C ~/Work/xpack-dev-tools/ninja-build-xpack.git`
} </CodeBlock>
...
xpm run docker-prepare --config ${ props.platform } -C ~/Work/xpack-dev-tools/ninja-build-xpack.git && \\
xpm run docker-link-deps --config ${ props.platform } -C ~/Work/xpack-dev-tools/ninja-build-xpack.git`
} </CodeBlock>
...
<CodeBlock language="sh"> {
`xpm run docker-build --config ${ props.platform } -C ~/Work/xpack-dev-tools/ninja-build-xpack.git`
} </CodeBlock>

or, for more verbosity, invoke the development build:

<CodeBlock language="sh"> {
`xpm run docker-build-development --config ${ props.platform } -C ~/Work/xpack-dev-tools/ninja-build-xpack.git`
} </CodeBlock>
