...
The **xPack Ninja Build** may be installed automatically, utilising the `xpm` command
(the recommended method), or manually, by downloading and unpacking one of the
platform-specific archives.

## Automated installation

The easiest (and recommended) method to install xPack Ninja Build
...
The command to install the **latest** available version of **ninja-build** is:
...
it is also possible to install xPack Ninja Build only globally in
...
In order to access the xPack Ninja Build binaries installed in
...
<CodeBlock language="sh"> {
`export PATH=$HOME/AppData/Roaming/xPacks/@xpack-dev-tools/ninja-build/1.13.1-1.1/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/Library/xPacks/@xpack-dev-tools/ninja-build/1.13.1-1.1/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/.local/xPacks/@xpack-dev-tools/ninja-build/1.13.1-1.1/.content/bin:$PATH
`} </CodeBlock>
...
<ul>
<li><code>xpack-ninja-build-1.13.1-1-win32-x64.zip</code></li>
</ul>
...
<ul>
<li><code>xpack-ninja-build-1.13.1-1-darwin-x64.tar.gz</code></li>
<li><code>xpack-ninja-build-1.13.1-1-darwin-arm64.tar.gz</code></li>
</ul>
...
example <code>/Users/ilg/Library/xPacks/ninja-build/xpack-ninja-build-1.13.1-1</code>:

<CodeBlock language="console"> {
`mkdir -p ~/Library/xPacks/ninja-build
cd ~/Library/xPacks/ninja-build

tar xvf ~/Downloads/xpack-ninja-build-1.13.1-1-darwin-x64.tar.gz
chmod -R -w xpack-ninja-build-1.13.1-1
`} </CodeBlock>
...
<ul>
<li><code>xpack-ninja-build-1.13.1-1-linux-x64.tar.gz</code></li>
<li><code>xpack-ninja-build-1.13.1-1-linux-arm64.tar.gz</code></li>
</ul>
...
example <code>/home/ilg/.local/xPacks/ninja-build/xpack-ninja-build-1.13.1-1</code>:

<CodeBlock language="console"> {
`mkdir -p ~/.local/xPacks/ninja-build
cd ~/.local/xPacks/ninja-build

tar xvf ~/Downloads/xpack-ninja-build-1.13.1-1-linux-x64.tar.gz
chmod -R -w xpack-ninja-build-1.13.1-1
`} </CodeBlock>
