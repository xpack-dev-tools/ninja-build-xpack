...
<CodeBlock language="sh"> {
`export PATH=$HOME/AppData/Roaming/xPacks/xpack-dev-tools/ninja-build/1.12.1-1.1/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/Library/xPacks/xpack-dev-tools/ninja-build/1.12.1-1.1/.content/bin:$PATH
`} </CodeBlock>
