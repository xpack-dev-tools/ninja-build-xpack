...
title: How to get help for the xPack Ninja Build
...
distribution, not to the upstream Ninja Build itself
(if you have doubts, use the GitHub Discussions),
or if you have a pertinent suggestion how to enhance the **xPack Ninja Build**
