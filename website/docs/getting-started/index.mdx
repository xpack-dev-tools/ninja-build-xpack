...
**xPack Ninja Build** is a standalone
cross-platform (Windows, macOS, GNU/Linux)binary distribution of Ninja Build,
intended for reproducible builds.

<Overview/>

The open source **xPack Ninja Build** project is hosted on GitHub as
...
[release assets](https://github.com/xpack-dev-tools/ninja-build-xpack/releases).

In addition to the binary archives and the package metadata,
this project also includes the
[build scripts](https://github.com/xpack-dev-tools/ninja-build-xpack/tree/xpack/build-assets/scripts).
...
[`ninja-build-xpack.git/build-assets/scripts`](https://github.com/xpack-dev-tools/ninja-build-xpack/tree/xpack/build-assets/scripts/)
...
- **Star** the project on [GitHub](https://github.com/xpack-dev-tools/ninja-build-xpack/): It helps others discover our work.
