...
(such as **1.12.1-1.1**) with the following expression:
...
- In `CHANGELOG.md`, add the release date and a message
  such as _**\* v1.12.1-1 released**_
...
tagged such as **v1.12.1-1** (mind the dash in the middle!) and
named such as **xPack Ninja Build v1.12.1-1** (mind the dash),
