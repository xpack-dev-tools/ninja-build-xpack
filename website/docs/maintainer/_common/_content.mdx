...
the **[Update the version specific code](http://localhost:3000/ninja-build-xpack/docs/maintainer/#update-the-version-specific-code)** section.
...
- add entries in the **Bug fixes**; use the following syntax
  ```
  - [[#N](https://github.com/xpack-dev-tools/ninja-build-xpack/issues/N)]:
  ```
...
[![NPM Version](https://img.shields.io/npm/v/%40xpack-dev-tools%2Fninja-build?color=green)](https://www.npmjs.com/package/@xpack-dev-tools/ninja-build/)
[![NPM Downloads](https://img.shields.io/npm/dm/%40xpack-dev-tools%2Fninja-build)](https://www.npmjs.com/package/@xpack-dev-tools/ninja-build/)
  - all releases [![NPM Downloads](https://img.shields.io/npm/dt/%40xpack-dev-tools%2Fninja-build)](https://www.npmjs.com/package/@xpack-dev-tools/ninja-build/)
