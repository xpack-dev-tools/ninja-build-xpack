...
npm dist-tag add @xpack-dev-tools/ninja-build@${customField('upstreamVersion')}-${customField('xpackSubversion')}.${customField('npmSubversion')} latest
npm dist-tag ls @xpack-dev-tools/ninja-build
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`npm unpublish @xpack-dev-tools/ninja-build@${customField('upstreamVersion')}-${customField('xpackSubversion')}.${customField('npmSubversion')}
`} </CodeBlock>
...
- paste the release name like _**xPack Ninja Build v{customField('upstreamVersion')}-{customField('xpackSubversion')} released**_
