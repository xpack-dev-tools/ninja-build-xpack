...
```sh
xpm run check-space -C ~/Work/xpack-dev-tools/ninja-build-xpack.git/build-assets
```
...
```sh
xpm run generate-workflows -C ~/Work/xpack-dev-tools/ninja-build-xpack.git/build-assets
```
...
```sh
xpm run trigger-workflow-build-darwin-x64 -C ~/Work/xpack-dev-tools/ninja-build-xpack.git/build-assets
xpm run trigger-workflow-build-darwin-arm64 -C ~/Work/xpack-dev-tools/ninja-build-xpack.git/build-assets
xpm run trigger-workflow-build-linux-x64 -C ~/Work/xpack-dev-tools/ninja-build-xpack.git/build-assets
xpm run trigger-workflow-build-win32-x64 -C ~/Work/xpack-dev-tools/ninja-build-xpack.git/build-assets
xpm run trigger-workflow-build-linux-arm64 -C ~/Work/xpack-dev-tools/ninja-build-xpack.git/build-assets
...
[GitHub Actions](https://github.com/xpack-dev-tools/ninja-build-xpack/actions) page.
...
```sh
xpm run trigger-workflow-test-prime -C ~/Work/xpack-dev-tools/ninja-build-xpack.git/build-assets
xpm run trigger-workflow-test-docker-linux-x64 -C ~/Work/xpack-dev-tools/ninja-build-xpack.git/build-assets
...
```sh
xpm run trigger-travis-macos -C ~/Work/xpack-dev-tools/ninja-build-xpack.git/build-assets
```
...
```sh
xpm run trigger-workflow-publish-release -C ~/Work/xpack-dev-tools/ninja-build-xpack.git/build-assets
```
...
watching the ninja-build-xpack project.
...
```sh
xpm run generate-website-blog-post -C ~/Work/xpack-dev-tools/ninja-build-xpack.git/build-assets
```
...
```sh
xpm run update-package-binaries -C ~/Work/xpack-dev-tools/ninja-build-xpack.git/build-assets
```
...
<a href="https://www.npmjs.com/package/@xpack-dev-tools/ninja-build?activeTab=versions">npmjs.com</a>.
...
```sh
xpm run trigger-workflow-test-xpm -C ~/Work/xpack-dev-tools/ninja-build-xpack.git/build-assets
```
...
- switch to https://xpack-dev-tools.github.io/ninja-build-xpack/docs/maintainer/#update-the-xpack-branch
...
```sh
xpm run trigger-workflow-deep-clean -C ~/Work/xpack-dev-tools/ninja-build-xpack.git/build-assets
```
...
[![Github All Releases](https://img.shields.io/github/downloads/xpack-dev-tools/ninja-build-xpack/latest/total)](https://github.com/xpack-dev-tools/ninja-build-xpack/releases)
  - all xPack releases [![Github All Releases](https://img.shields.io/github/downloads/xpack-dev-tools/ninja-build-xpack/total)](https://github.com/xpack-dev-tools/ninja-build-xpack/releases)
  - [individual file counters](https://somsubhra.github.io/github-release-stats/?username=xpack-dev-tools&repository=ninja-build-xpack) (grouped by release)
- npmjs.com [`@xpack-dev-tools/ninja-build`](https://www.npmjs.com/package/@xpack-dev-tools/ninja-build/) xPack
  - latest release, per month
[![npm (scoped)](https://img.shields.io/npm/v/@xpack-dev-tools/ninja-build)](https://www.npmjs.com/package/@xpack-dev-tools/ninja-build/)
[![npm](https://img.shields.io/npm/dm/@xpack-dev-tools/ninja-build)](https://www.npmjs.com/package/@xpack-dev-tools/ninja-build/)
  - all releases [![npm](https://img.shields.io/npm/dt/@xpack-dev-tools/ninja-build)](https://www.npmjs.com/package/@xpack-dev-tools/ninja-build/)
