...
const config: Config = {
  title: 'xPack Ninja Build',
  tagline: 'A binary distribution of Ninja Build',
    ...
    [
      'classic',
      {
        ...
        sitemap: {
          ...
          priority: 0.5,
          ignorePatterns: [
            '/ninja-build-xpack/blog/archive/**',
            '/ninja-build-xpack/blog/authors/**',
            '/ninja-build-xpack/blog/tags/**'
          ],
    ...
    navbar: {
      ...
      items: [
        ...
        },
        {
          ...
          position: 'right',
          href: `https://github.com/xpack-dev-tools/ninja-build-xpack/releases/tag/v${customFields.xpackVersion}`,
        },
        {
          ...
          items: [
            {
              ...
              href: 'https://github.com/xpack-dev-tools/ninja-build-xpack/discussions',
            },
            {
