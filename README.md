...
```console
$ tree -L 2 /Users/ilg/Library/xPacks/\@xpack-dev-tools/ninja-build/1.12.1-1.1/.content/
/Users/ilg/Library/xPacks/\@xpack-dev-tools/ninja-build/1.12.1-1.1/.content/
├── README.md
├── bin
│   └── ninja
└── distro-info
...
like `1.12.1-1`. When published as a npm package, the version gets
a fifth number, like `1.12.1-1.1`.

Since adherence of third party packages to semver is not guaranteed,
it is recommended to use semver expressions like `^1.11.1` and `~1.11.1`
with caution, and prefer exact matches, like `1.12.1-1.1`.
